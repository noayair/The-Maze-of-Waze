...
public class DGraphTest {
    ...
    public void addNode() { //test also getV
        ...
        assertEquals("8" , gr.getNode(8).toString());
        assertEquals("[1, 2, 3, 4, 5, 6, 7, 8]" , gr.getV().toString());
    }
    ...
    public void connect() { //test also getE
        graph gr = create_graph();
        System.out.println(gr.getMC());
        assertEquals("[3, 5]" , gr.getE(1).toString());
        assertEquals("[1, 4, 8]" , gr.getE(2).toString());
        assertEquals("[2, 4]" , gr.getE(3).toString());
        assertEquals("[1, 5, 6]" , gr.getE(4).toString());
        assertEquals("[3]" , gr.getE(5).toString());
        assertEquals("[7]" , gr.getE(6).toString());
        assertEquals("[5]" , gr.getE(7).toString());
        assertEquals("[4]" , gr.getE(8).toString());
    }
    ...
    public void removeNode() {
        ...
        System.out.println(gr.getMC());
        gr.removeNode(8);
        assertEquals("[1, 2, 3, 4, 5, 6, 7]" , gr.getV().toString());
        assertEquals("[1, 4]" , gr.getE(2).toString());
    }
    ...
    public void removeEdge() {
        ...
        System.out.println(gr.getMC());
        gr.removeEdge(4,1);
        assertEquals("[5, 6]" , gr.getE(4).toString());
    }
